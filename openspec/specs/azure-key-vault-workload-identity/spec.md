## Purpose
Define the shared workload identity contract for homelab Azure Key Vault access through External Secrets Operator and the primary `azure-kv-store` ClusterSecretStore.
