...
| [003 - Development Standards](./003-development-standards.md) | Conventions for Kubernetes manifests, secret management, database standards, and GitOps workflow |
| [004 - Warehouse Access Reconciliation](./004-warehouse-access-reconciliation.md) | Role naming contract, privilege reconciler behavior, Key Vault key mapping, validation checklist, and rollback guidance for warehouse access controls |
